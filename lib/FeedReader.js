...
function template(article, post_info) {
  item = "<article>" +
    "<div class='blog-post-img'>" +
       "<img alt='Blog Image' src='" + post_info.og_image + "&resize=360%2C220' class='img-responsive'>" +
    "</div>" +
    ...
    "</div>" +
    "<a href='" + article.link + "' class='btn btn-theme'> Leer más... <i class='fa fa-angle-double-right'></i></a>" +     
  "</article>"
